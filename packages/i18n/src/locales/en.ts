...
export const en: Record<string, string> = {
    ...
    // ── App.tsx ──
    'app.welcome': '👋 Welcome to Open Agent! Configuration file is incomplete. Please configure the following required fields:',
    'app.welcome.baseUrl': '  • baseUrl — API service URL',
    'app.welcome.apiKey': '  • apiKey  — API key',
    'app.welcome.model': '  • model   — Model name',
