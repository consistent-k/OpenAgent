...
```typescript
export async function runAgent(messages: ModelMessage[], abortSignal?: AbortSignal): Promise<ReturnType<typeof streamText>>;
```
...
pnpm version:all      # 统一升级版本号（patch/minor/major）
